...
namespace ProyectoTest.Controllers
{
    public class TiendaController : Controller
    {
                ...
                oLista = (from d in oLista
                          select new Carrito()
                          {
                              ...
                              oProducto = new Producto()
                              {
                                  ...
                                  Descripcion = d.oProducto.Descripcion,
        ...
        [HttpPost]
        public JsonResult RegistrarCompra(Compra oVenta)
        {
            bool respuesta = false;

            oVenta.IdUsuario = oUsuario.IdUsuario;
            respuesta = CompraLogica.Instancia.Registrar(oVenta);
            return Json(new { resultado = respuesta }, JsonRequestBehavior.AllowGet);
        }
                      ...
                      select new Compra()
                      {
                          ...
                          oDetalleCompra = (from dc in c.oDetalleCompra
                                            select new DetalleCompra()
                                            {
                                                oProducto = new Producto()
                                                {
                                                    Descripcion = dc.oProducto.Descripcion,
