                        ...
                        while (dr.Read())
                        {
                            lst.Add(new Carrito()
                            {
                                ...
                                oProducto = new Producto()
                                {
                                    ...
                                    Precio = Convert.ToDecimal(dr["Precio"].ToString(), new CultureInfo("en-US")),
                        ...
                        while (dr.Read())
                        {
                            ...
                            if (doc.Element("DATA") != null)
                            {
                                rptDetalleCompra = (from c in doc.Element("DATA").Elements("COMPRA")
                                                    select new Compra()
                                                    {
                                                        Total = Convert.ToDecimal(c.Element("Total").Value, new CultureInfo("en-US")),
                                                        ...
                                                        oDetalleCompra = (from d in c.Element("DETALLE_PRODUCTO").Elements("PRODUCTO")
                                                                          select new DetalleCompra()
                                                                          {
                                                                              ...
                                                                              Total = Convert.ToDecimal(d.Element("Total").Value, new CultureInfo("en-US")),
